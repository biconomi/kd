...
<div class="modal fade in" id="modal-add_user" style="display: none; padding-right: 17px;" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="post" name="frmCreateUser" id="frmCreateUser">
          {{ csrf_field() }}
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div id="div_txtpassword" class="form-group has-success">
                  <label for="exampleInputPassword1">Mật khẩu</label>
                  <input type="password" class="form-control" id="txtpassword" name="txtpassword" placeholder="Mật khẩu từ 6-8 ký tự" maxlength="8">
                </div> 
